  ...
  <section class="panel">
    <div class="home">
      <div class="version-user-row" style="display:flex;align-items:center;justify-content:center;gap:10px;position:relative;margin-bottom:18px">
        <div style="display:inline-flex;align-items:center;padding:6px 12px;border-radius:999px;background:#eee9ff;color:#694ae2;font-weight:800">PRO 4.9.4 · 29.08.2026</div>
...
if('serviceWorker'in navigator){window.addEventListener('load',()=>navigator.serviceWorker.register('./sw.js?v=4.9.4',{updateViaCache:'none'}).catch(console.error))}
