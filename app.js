...
function appAsset(name){return `${APP_ASSET_BASE}/${encodeURIComponent(name)}?v=5.0.8`}
...
function updateStaticAppVersion(){
  const target='PRO 5.0.8 · 29.08.2026';
...
const views={
  ...
  <section class="panel">
    <div class="home">
      ...
      <div class="app-footer-version">PRO 5.0.8 · 29.08.2026</div>
    </div>
  </section>
`,
...
if('serviceWorker'in navigator){window.addEventListener('load',()=>navigator.serviceWorker.register('./sw.js?v=5.0.8',{updateViaCache:'none'}).catch(console.error))}
