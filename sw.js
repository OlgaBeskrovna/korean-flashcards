const CACHE='korean-flashcards-pro-4.8.12';
const ASSETS=['./','./index.html','./style.css?v=4.8.12','./app.js?v=4.8.12','./data.js?v=4.8.12','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
...
self.addEventListener('fetch',event=>{
  ...
  // Network first for code so a deployment is visible immediately; cache fallback keeps offline mode.
